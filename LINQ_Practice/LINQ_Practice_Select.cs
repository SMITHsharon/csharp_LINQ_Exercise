     ...
     */
    {
        ...
        public void GetAllPrimaryInstructorsInAllCohorts()
        {
            ...
            CollectionAssert.AreEqual(expected, 
                new List<Instructor> { CohortBuilder.Instructor2,
                                       CohortBuilder.Instructor6,
                                       CohortBuilder.Instructor3,
                                       CohortBuilder.Instructor1});
        }
        ...
        public void GetAllStudents()
        {
            ...
            CollectionAssert.AreEqual(expected, 
                new List<Student> { CohortBuilder.Student1,
        ...
        public void GetAllPrimaryInstructorFirstNames()
        {
            ...
            CollectionAssert.AreEqual(expected, 
                new List<string> { "Jurnell", "Zachary", "Blaise", "Kate" });
        }
        ...
        public void GetAllCohortNames()
        {
            ...
            CollectionAssert.AreEqual(expected, 
                new List<string> { "Evening Five",
                                   "Cohort of the Future",
                                   "Evening Ninja Warriors",
                                   "Day Backgammon Geeks" });
        }
    }
}
